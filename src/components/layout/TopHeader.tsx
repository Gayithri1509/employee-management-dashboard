...
function TopHeader({ searchTerm, onSearchChange, onOpenMobileNav, onOpenActivity, activityCount }: TopHeaderProps) {
  return (
    <header className="sticky top-0 z-30 border-b border-slate-200/70 bg-white/80 backdrop-blur">
      <div className="flex items-center gap-4 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="min-w-0">
          <p className="text-xs font-medium uppercase tracking-wide text-indigo-500">{getGreeting()}</p>
